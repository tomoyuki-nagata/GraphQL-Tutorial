...
func (ec *executionContext) _Repository_issues(ctx context.Context, field graphql.CollectedField, obj *model.Repository) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNIssueConnection2ᚖgraphqlᚑtutorialᚋgraphᚋmodelᚐIssueConnection(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Repository_pullRequests(ctx context.Context, field graphql.CollectedField, obj *model.Repository) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNPullRequestConnection2ᚖgraphqlᚑtutorialᚋgraphᚋmodelᚐPullRequestConnection(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNIssueConnection2ᚖgraphqlᚑtutorialᚋgraphᚋmodelᚐIssueConnection(ctx context.Context, sel ast.SelectionSet, v *model.IssueConnection) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNPullRequestConnection2ᚖgraphqlᚑtutorialᚋgraphᚋmodelᚐPullRequestConnection(ctx context.Context, sel ast.SelectionSet, v *model.PullRequestConnection) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
